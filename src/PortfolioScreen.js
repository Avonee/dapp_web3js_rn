...
const Portfolio: () => Node = (props) => {
    ...
    const getAccountTransactions = (accAddress, startBlockNumber, endBlockNumber) => {
    ...
    useEffect(() => {
        const unsubscribe = props.navigation.addListener('focus', async () => {
            ...
            ///testtest
            // getAccountTransactions('0x3D24709C3443dA67fd20b1A131a938221a9C3A28', 9083657, 9086289)
